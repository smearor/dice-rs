...
/// The fixed score for a Yatzy (five of a kind).
...
mod tests {
    ...
    fn yatzy() {
        ...
        assert_eq!(calculate_score(ScoreCategory::Yatzy, &d), Score::new(50));
    }

    #[test]
    fn yatzy_none() {
        let d = dice([1, 2, 3, 4, 5]);
        assert_eq!(calculate_score(ScoreCategory::Yatzy, &d), Score::ZERO);
    }
